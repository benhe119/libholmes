...
public class Inet4LooseSourceRouteOptionTest {
    @Test
    public void test() throws ParseException {
        // Test data generated using nmap with the --ip-options L option.
        HexOctetReader reader = new HexOctetReader(
            "831304c0a80001ac1000010a0000010a000002");
        Inet4Option rawOption = Inet4Option.parse(null, reader);
        assertEquals(0, reader.remaining());
        assertTrue(rawOption instanceof Inet4LooseSourceRouteOption);
        Inet4LooseSourceRouteOption option = (Inet4LooseSourceRouteOption) rawOption;

        assertEquals(131, option.getType());
        ...
        assertEquals(131, json.getInt("type"));
