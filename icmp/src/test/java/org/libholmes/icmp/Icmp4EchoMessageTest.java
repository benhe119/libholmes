...
public class Icmp4EchoMessageTest {
    @Test
    public void test() throws ParseException {
        HexOctetReader content = new HexOctetReader(
            "0800b00151ef00074de9875a" +
        ...
        assertTrue(icmpMessage instanceof Icmp4EchoMessage);

        Icmp4EchoMessage decodedMessage = (Icmp4EchoMessage) icmpMessage;
        assertEquals(8, decodedMessage.getType());
        assertEquals(0, decodedMessage.getCode());
        assertEquals(0xb001, decodedMessage.getRecordedChecksum());
        assertEquals(0xb001, decodedMessage.getCalculatedChecksum());
        ...
        assertEquals(8, jsonMessage.getInt("type"));
        assertEquals(0, jsonMessage.getInt("code"));
        assertEquals(0xb001, jsonMessage.getInt("recordedChecksum"));
        assertEquals(0xb001, jsonMessage.getInt("calculatedChecksum"));
