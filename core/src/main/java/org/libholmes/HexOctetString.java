...
/** An OctetString class to represent the content of a hex string. */
public class HexOctetString extends ArrayOctetString {
    ...
    /** Construct HexOctetString from a hex string.
     ...
     */
    public HexOctetString(String hex) {
